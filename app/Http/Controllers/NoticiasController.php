...
class NoticiasController extends Controller
{
    ...
    public function update($id, Request $request) {
        ...
        if ($noticia){
            ...
            if ($noticia->save()) {
                return redirect()->route('noticias.edit', $noticia->id)->with('exito', 'Se actualizo correctamente');
            }

            return edirect()->route('noticias.edit', $noticia->id)->with('error', 'No se pudo actualizar');
        }
